...
let
    ...
    mempool = {
      ...
      frontend = {
        ...
        staticContentRoot = mkOption {
          type = types.path;
          default = pkgs.sovran-bitcoin.mempool-frontend.withConfig cfg.frontend.settings;
          defaultText = "pkgs.sovran-bitcoin.mempool-frontend";
          description = "
      ...
      package = mkOption {
        type = types.package;
        default = pkgs.sovran-bitcoin.mempool-backend;
        defaultText = "pkgs.sovran-bitcoin.mempool-backend";
  ...
  # Vendored mempool nginx conf snippets ship with the flake's packages
  ...
  frontend.nginxConfig = {
    ...
    httpConfig = ''
      include ${pkgs.sovran-bitcoin.mempool-nginx-conf}/http-language.conf;
    '';
    ...
    staticContent = ''
      ...
      include ${pkgs.sovran-bitcoin.mempool-nginx-conf}/location-static.conf;
